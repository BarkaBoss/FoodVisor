...
public class RestaurantObj {
    ...
    String rest_name, rest_id, rest_mail, rest_phone, rest_address, rest_imgUrl, rest_features;

    public RestaurantObj()
    {}

    public RestaurantObj(String rest_name, String rest_id, String rest_mail, String rest_phone, String rest_address, String rest_imgUrl, String rest_features) {
